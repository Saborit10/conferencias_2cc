...
%\newenvironment{proposition}{\begin{dBox}\begin{propositionT}}{\end{propositionT}\end{dBox}}
...
% TODO Agragar una imagen de cicl o negativo y explicarlA
